...
$user = fetchone('uid, userid, year, name, email, phone, website, remark, UNIX_TIMESTAMP(updated_on) updated FROM users WHERE uid = ?', $my->uid) or notfound();
?>
<h2>정보수정</h2>
...
<tr><th>웹사이트<td><input type=text name=website size=40 value="<?= h($user->website) ?>">
